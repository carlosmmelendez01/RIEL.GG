...
export const metadata: Metadata = {
  ...
  description: "RIEL.GG student privacy, FERPA, and COPPA posture.",
};
  ...
  return (
    <LegalShell title="Privacy Policy" eyebrow="Student privacy" updated="June 16, 2026">
      <Section title="Beta notice">
        <p>
          This policy is a beta compliance draft for school review and legal counsel. RIEL.GG
      ...
      <Section title="FERPA / COPPA posture">
        <p>
          When RIEL.GG is used by a school, student records are handled under the school&apos;s
          direction. For under-13 students, RIEL.GG requires school authorization or parent /
      ...
      <Section title="No ads or sale of student data">
        <p>
          RIEL.GG does not sell student data, run behavioral advertising, or build commercial
      ...
      <Section title="Contact">
        <p>
          ...
          league operator while RIEL.GG is in beta.
        </p>
      </Section>
    </LegalShell>
  );
