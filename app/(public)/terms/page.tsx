...
export const metadata: Metadata = {
  ...
  description: "RIEL.GG beta terms for schools, coaches, league admins, and players.",
};
    ...
    <LegalShell title="Terms of Service" eyebrow="Beta terms" updated="June 16, 2026">
      <Section title="Beta notice">
        <p>
          ...
          changed, or removed while RIEL.GG is tested with schools and leagues.
        </p>
      </Section>
      <Section title="Authorized use">
        <p>
          RIEL.GG is for school and league esports administration: applications, rosters,
          schedules, match reporting, standings, check-ins, and related communications.
        </p>
      </Section>
      <Section title="School responsibility">
        <p>
          Schools are responsible for deciding which staff and students may use RIEL.GG,
      ...
      <Section title="Agreement acceptance">
        <p>
          ...
          agreement version during onboarding before admin tools are available. RIEL.GG records
      ...
      <Section title="Student conduct">
        <p>
          ...
          upload harmful content, or use RIEL.GG outside school-approved competition activity.
        </p>
      </Section>
      <Section title="Data use limits">
        <p>
          RIEL.GG may use data to operate, secure, audit, support, and improve the school
      ...
      <Section title="Suspension">
        <p>
          RIEL.GG or the league operator may suspend accounts, teams, or access when needed for
