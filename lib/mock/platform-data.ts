...
import { INDIANA_CCD_SCHOOL_FIXTURES } from "@/lib/mock/school-directory-fixtures";
...
export const PLATFORM_SCHOOLS: PlatformSchool[] = [
  ...
  { id: "ps-mchs", name: "Michigan City High School", shortName: "Michigan City", code: "MCH", city: "Michigan City", state: "IN", ncesId: INDIANA_CCD_SCHOOL_FIXTURES["ps-mchs"].externalId, ncesVerified: true, primaryColor: "#1f3a8a", ownerName: "Carlos Melendez", ownerEmail: "cmelendez@mcas.k12.in.us", studentCount: 51, leagueIds: ["lg-riel"], status: "ACTIVE", joinedAgo: "8mo" },
  { id: "ps-carmel", name: "Carmel High School", shortName: "Carmel", code: "CAR", city: "Carmel", state: "IN", ncesId: INDIANA_CCD_SCHOOL_FIXTURES["ps-carmel"].externalId, ncesVerified: true, primaryColor: "#1f3a8a", ownerName: "Robert Han", ownerEmail: "rhan@carmel.k12.in.us", studentCount: 47, leagueIds: ["lg-riel", "lg-hea"], status: "ACTIVE", joinedAgo: "8mo" },
  { id: "ps-fishers", name: "Fishers High School", shortName: "Fishers", code: "FHS", city: "Fishers", state: "IN", ncesId: INDIANA_CCD_SCHOOL_FIXTURES["ps-fishers"].externalId, ncesVerified: true, primaryColor: "#7c2d12", ownerName: "Riya Patel", ownerEmail: "rpatel@hse.k12.in.us", studentCount: 38, leagueIds: ["lg-riel", "lg-hea"], status: "ACTIVE", joinedAgo: "2y" },
  { id: "ps-hse", name: "Hamilton Southeastern HS", shortName: "HSE", code: "HSE", city: "Fishers", state: "IN", ncesId: INDIANA_CCD_SCHOOL_FIXTURES["ps-hse"].externalId, ncesVerified: true, primaryColor: "#365314", ownerName: "Elena Vasquez", ownerEmail: "evasquez@hse.k12.in.us", studentCount: 42, leagueIds: ["lg-riel"], status: "ACTIVE", joinedAgo: "2y" },
  { id: "ps-nch", name: "North Central High School", shortName: "North Central", code: "NCH", city: "Indianapolis", state: "IN", ncesId: INDIANA_CCD_SCHOOL_FIXTURES["ps-nch"].externalId, ncesVerified: true, primaryColor: "#831843", ownerName: "Jonah Reed", ownerEmail: "jreed@nc.k12.in.us", studentCount: 33, leagueIds: ["lg-riel"], status: "ACTIVE", joinedAgo: "1y" },
  { id: "ps-cgv", name: "Center Grove High School", shortName: "Center Grove", code: "CGV", city: "Greenwood", state: "IN", ncesId: INDIANA_CCD_SCHOOL_FIXTURES["ps-cgv"].externalId, ncesVerified: true, primaryColor: "#581c87", ownerName: "Tessa Nakamura", ownerEmail: "tnakamura@cgv.k12.in.us", studentCount: 36, leagueIds: ["lg-riel"], status: "ACTIVE", joinedAgo: "1y" },
  { id: "ps-brebeuf", name: "Brebeuf Jesuit", shortName: "Brebeuf", code: "BRE", city: "Indianapolis", state: "IN", ncesId: undefined, ncesVerified: false, primaryColor: "#0c4a6e", ownerName: "Antonio Reyes", ownerEmail: "areyes@brebeuf.org", studentCount: 24, leagueIds: ["lg-riel"], status: "ACTIVE", joinedAgo: "10mo" },
  { id: "ps-cathedral", name: "Cathedral HS", shortName: "Cathedral", code: "CTH", city: "Indianapolis", state: "IN", ncesId: undefined, ncesVerified: false, primaryColor: "#78350f", ownerName: "Patrick O'Sullivan", ownerEmail: "posullivan@cathedral.org", studentCount: 28, leagueIds: ["lg-riel"], status: "ACTIVE", joinedAgo: "8mo" },

  // HEA schools (some overlap with RIEL)
  { id: "ps-westfield", name: "Westfield High School", shortName: "Westfield", code: "WST", city: "Westfield", state: "IN", ncesId: INDIANA_CCD_SCHOOL_FIXTURES["ps-westfield"].externalId, ncesVerified: true, primaryColor: "#0F4D8C", ownerName: "Jamie Holcomb", ownerEmail: "jholcomb@wws.k12.in.us", studentCount: 45, leagueIds: ["lg-hea"], status: "ACTIVE", joinedAgo: "5mo" },
  { id: "ps-zionsville", name: "Zionsville Community High School", shortName: "Zionsville", code: "ZON", city: "Zionsville", state: "IN", ncesId: INDIANA_CCD_SCHOOL_FIXTURES["ps-zionsville"].externalId, ncesVerified: true, primaryColor: "#0F4D8C", ownerName: "Tomás Velez", ownerEmail: "tvelez@zcs.k12.in.us", studentCount: 31, leagueIds: ["lg-hea"], status: "ACTIVE", joinedAgo: "4mo" },
  { id: "ps-plainfield", name: "Plainfield High School", shortName: "Plainfield", code: "PFD", city: "Plainfield", state: "IN", ncesId: INDIANA_CCD_SCHOOL_FIXTURES["ps-plainfield"].externalId, ncesVerified: true, primaryColor: "#7C1D1D", ownerName: "John Newbold", ownerEmail: "jnewbold@plainfield.k12.in.us", studentCount: 29, leagueIds: ["lg-hea"], status: "PENDING", joinedAgo: "3d" },
  { id: "ps-crownpoint", name: "Crown Point High School", shortName: "Crown Point", code: "CPT", city: "Crown Point", state: "IN", ncesId: INDIANA_CCD_SCHOOL_FIXTURES["ps-crownpoint"].externalId, ncesVerified: true, primaryColor: "#0F4D8C", ownerName: "Ricardo Jenkins", ownerEmail: "rjenkins@cps.k12.in.us", studentCount: 22, leagueIds: ["lg-hea"], status: "PENDING", joinedAgo: "8h" },
  ...
  { id: "ps-bishop", name: "Bishop Chatard HS", shortName: "Bishop Chatard", code: "BCH", city: "Indianapolis", state: "IN", ncesId: undefined, ncesVerified: false, primaryColor: "#831843", ownerName: "Father Daniel Quinn", ownerEmail: "dquinn@bishopchatard.org", studentCount: 0, leagueIds: ["lg-hea"], status: "PENDING", joinedAgo: "1d" },
];
